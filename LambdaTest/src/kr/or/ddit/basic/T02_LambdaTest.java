 ...
 */
		...
		LambdaTestInf2 lam3 = (int z)->{
			int result = z + 100;
			System.out.println("result = " + result);
		};
		lam3.test(30);
		
		LambdaTestInf2 lam4 = z -> {
			int result = z + 300;
			System.out.println("result = " + result);
		};
		lam4.test(60);
		
		LambdaTestInf2 lam5 = z -> System.out.println("result = " + (z+500));
		lam5.test(90);
		System.out.println("----------------------------------------------");
		
		LambdaTestInf3 lam6 = (int x, int y)->{
			int r = x + y;
			return r;
		};
		...
		LambdaTestInf3 lam7 = (x, y)->{
			return x + y;
		};
		k = lam7.test(80, 50);
		System.out.println("k = " + k);
		
		LambdaTestInf3 lam8 = (x, y) -> x + y;
		k = lam8.test(100, 200);
		System.out.println("k = " + k);
		
		LambdaTestInf3 lam9 = (x, y) -> x > y ? x : y;
		k = lam9.test(100, 200);
		System.out.println("k = " + k);
